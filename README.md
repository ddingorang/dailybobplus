...
### 현재 feature
- **사진 대신 글이 게시되었을 때는 글을 크롤링**
- ~~사실 메뉴가 올라오는 모든 방식에 대해 대응하기 어려움 ㅠ~~
- ~~(글이랑 사진이 섞이거나, 일주일치 식단을 한꺼번에 올린다던지, 중식/석식을 섞어서 올린다던지, ...)~~
- ~~하루에 한 장씩만 올려줬으면 좋겠다~~

### 25.02.03
- **밥플러스 네이버 블로그 운영 종료 -> 카카오톡 채널로 전환**
- 그래도 5기 기간동안 잘 써먹은 것에 의의를 두자
...
- **asia-southeast 지역에는 3000MB 제한이 걸려 있음**
